package mx.com.lgonzalez.data.repositories

import android.app.Application
import android.util.Log
import mx.com.lgonzalez.data.local.PokemonEntity
import mx.com.lgonzalez.data.local.PokemonTypeEntity
import mx.com.lgonzalez.data.local.TechnicalTestDatabase
import mx.com.lgonzalez.data.local.TypeEntity
import mx.com.lgonzalez.data.models.PokemonDetails
import mx.com.lgonzalez.data.network.PokemonApi
import mx.com.lgonzalez.data.mappers.toDomainModel
import mx.com.lgonzalez.data.mappers.toEntity
...
class PokemonRepositoryImpl @Inject constructor(
    ...
    override suspend fun getPokemons(
     ...
     private suspend fun getPokemonNetwork(name: String): PokemonDetails? {
        return try {
    ...
    override suspend fun updatePokemon(pokemon: Pokemon) {
        technicalTestDatabase.pokemonDao().updatePokemon(pokemon.toEntity())
    }
